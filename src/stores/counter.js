...
export const useCounterStore = defineStore('counter', () => {
  ...
  // Daftar gambar team
  const team = ref([
    { name: "Alice", role: "Founder & CEO", image: "@/assets/img/team1.webp" },
    { name: "Bob", role: "Veterinarian", image: "@/assets/img/team2.webp" },
    { name: "Charlie", role: "Adoption Specialist", image: "@/assets/img/team3.webp" }
  ])
